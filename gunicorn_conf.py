...
pidfile = '/www/wwwroot/djangoProject/gunicorn.pid'

# 设置访问日志和错误信息日志路径
accesslog = '/www/wwwlogs/python/djangoProject/gunicorn_acess.log'
errorlog = '/www/wwwlogs/python/djangoProject/gunicorn_error.log'
